        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              ...
              <h3>Bliss Shore Ayur Care</h3>
              <p>Post Natal Care Centre</p>
              <p className="footer-tagline">Connection and Prosperity</p>
              <div className="footer-social">
                ...
                <a href="https://wa.me/917090806606" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="WhatsApp">
                  <WhatsAppIconSmall />
                </a>
              </div>
            </div>
            ...
            <div className="footer-contact">
              ...
              <p>
                ...
                CW36 735, Kizhakkoth<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kerala 673572, India
              </p>
              <p>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ verticalAlign: 'middle', marginRight: '6px' }}>
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <a href="tel:+917090806606">+91 7090 806 606</a>
              </p>
              <p>
                ...
                <a href="https://wa.me/917090806606" target="_blank" rel="noopener noreferrer">WhatsApp</a>
              </p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Bliss Shore Ayur Care. All rights reserved.</p>
          </div>
        </div>
      </footer>
